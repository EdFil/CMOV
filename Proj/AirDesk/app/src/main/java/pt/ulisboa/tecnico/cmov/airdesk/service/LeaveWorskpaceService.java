 ...
 */
public class LeaveWorskpaceService implements AirDeskService {
    ...
    public JSONObject execute(JSONArray arguments) {
        ...
        try {
            ...
            String email = arguments.getString(1);
            ...
            WorkspaceManager.getInstance().removeAccessToUser(email, workspace);
