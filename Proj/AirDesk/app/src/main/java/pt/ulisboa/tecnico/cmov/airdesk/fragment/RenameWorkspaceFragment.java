...
public class RenameWorkspaceFragment extends DialogFragment {
    ...
    OnWorkspaceUpdatedListener mCallback;
    ...
    public interface OnWorkspaceUpdatedListener  {
        void onWorkspaceInfoChanged();
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mCallback = (OnWorkspaceUpdatedListener) activity;
        ...
        public void onClick(View v) {
            ...
            try {
                if(mWorkspace instanceof LocalWorkspace) {
                    WorkspaceManager.getInstance().renameWorkspace(mWorkspace, mNameEditText.getText().toString());
