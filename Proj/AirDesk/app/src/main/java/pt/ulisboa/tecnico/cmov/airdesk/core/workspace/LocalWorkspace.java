...
public class LocalWorkspace extends Workspace {
    ...
    public LocalWorkspace(Context context, String name, String owner, int quota, boolean isPrivate, Tag[] tags, User[] users, File[] files, WorkspaceManager workspaceManager) {
